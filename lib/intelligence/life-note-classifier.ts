...
const HEALTH_SIGNAL_PATTERN =
  /\b(sleep was|slept|rough night|tired|exhausted|low energy|headache|migraine|sore|pain|symptom|felt sick|not feeling well|chest (felt )?tight|felt tight|tight chest)\b/i;
