...
export const themeColors: Record<"light" | "dark", ThemeColorSet> = {
  ...
  dark: {
    income: "oklch(0.72 0.14 155)",
    incomeMuted: "oklch(0.62 0.12 155 / 0.2)",
    expense: "oklch(0.88 0 0)",
    expenseMuted: "oklch(0.32 0.01 260)",
    warning: "oklch(0.78 0.12 85)",
    warningMuted: "oklch(0.78 0.12 85 / 0.15)",
    progressFrom: "oklch(0.65 0.14 155)",
    progressTo: "oklch(0.72 0.12 155)",
    glow: "oklch(0.62 0.12 155 / 0.2)",
